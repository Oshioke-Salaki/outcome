...
contract DeployScript is Script {
    address constant USDC_ADDRESS = 0xAB6a56DA5c42976953FE245F478f0b183B2479BF; // testnet USDC
    ...
    function run() external {
        ...
        SkyOdds market = new SkyOdds(USDC_ADDRESS, oracleResolverTemp);
        ...
        console.log("----------------------------------------");
        console.log("Token (MockUSDC):", USDC_ADDRESS);
