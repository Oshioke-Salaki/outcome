    ...
    <div className="container py-10 space-y-8">
      <div className="space-y-2">
        ...
        <p className="text-zinc-500">
          Source real-time flight data from AviationStack to initialize
          high-fidelity prediction markets.
        </p>
      </div>
      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-8 text-white relative overflow-hidden group">
        <div className="relative z-10">
          ...
          <p className="text-zinc-400 max-w-lg mb-6 text-sm">
            Outcome uses verified flight data for market settlement. Every
            market created here is backed by real-time aviation telemetry,
            ensuring fair outcomes for all traders.
          </p>
